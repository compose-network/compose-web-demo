...
interface ImportMetaEnv {
  ...
  readonly VITE_ROLLUP_A_KERNEL_IMPL?: string;
  readonly VITE_ROLLUP_A_KERNEL_FACTORY?: string;
  readonly VITE_ROLLUP_A_MULTICHAIN_VALIDATOR?: string;
  readonly VITE_ROLLUP_A_META_FACTORY?: string;
  readonly VITE_ROLLUP_B_KERNEL_IMPL?: string;
  readonly VITE_ROLLUP_B_KERNEL_FACTORY?: string;
  readonly VITE_ROLLUP_B_MULTICHAIN_VALIDATOR?: string;
  readonly VITE_ROLLUP_B_META_FACTORY?: string;
  readonly VITE_ROLLUP_A_BRIDGE_ADDRESS?: string;
  readonly VITE_ROLLUP_B_BRIDGE_ADDRESS?: string;
  readonly VITE_BRIDGE_TOKEN_ADDRESS?: string;
  readonly VITE_WETH_ADDRESS?: string;
  readonly VITE_USDC_ADDRESS?: string;
  readonly VITE_SSV_ADDRESS?: string;
