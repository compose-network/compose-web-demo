  ...
  return (
    <>
      ...
      <Text variant={"body-3-medium"} className="text-gray-600">
        Compose Network unites Ethereum rollups to enable{" "}
        <span className="font-bold">
          instant, atomic, and composable transactions
        </span>
        .
      </Text>

      <Text variant={"body-3-medium"} className="text-gray-600">
        In this demo, you'll bridge and swap tokens between two demo rollups to
        experience real cross-rollup composability.
      </Text>
