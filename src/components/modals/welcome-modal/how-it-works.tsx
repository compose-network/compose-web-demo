  ...
  <>
    <div className="flex flex-col items-center gap-6">
      ...
      <Text variant={"body-3-medium"} className="text-gray-600 w-full">
        ...
        independent sequencer. They’re connected through Compose’s Shared
        Publisher, which leads the synchronous composability protocol — enabling
        these rollups to operate together as one coordinated system.
      </Text>
      <Text variant={"body-3-medium"} className="text-gray-600 w-full">
        That’s how synchronous composability achieves atomicity: transactions
        across rollups either happen together or not at all, finalizing
        instantly once both sides confirm.
      </Text>
      <Text variant={"body-3-medium"} className="text-gray-600 w-full">
        Powered by account abstraction, Compose lets you sign once while
        multiple operations — swaps, bridges, and transfers — execute
        synchronously across rollups in the background.
      </Text>
      <Text variant={"body-3-medium"} className="text-gray-600 w-full">
        What normally takes multiple steps, chains, and confirmations happens
        here in one seamless atomic flow.
      </Text>
...
const HowItWorks = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative z-[10000] bg-white rounded-[40px] shadow-2xl p-8 max-w-[648px] mx-4 border border-gray-200">
        <button
          onClick={onClose}
